...
namespace NeuralNetworkProcessor.Samples.Calculator
{
    ...
    public partial record LineTerminator(
        [Pattern(
            ...
            "&#x0085;",
            AsPatterns = true
            )]string _LineTerminator = default
        ) : Node;
    ...
    public partial record _(
        ...
        [Pattern] (_, Space) _Space = default
        ) : Node;
    ...
    public partial record Mul(
        [Pattern(null, "*")] (_, string) _Mul = default
        ) : Node;
    public partial record Div(
        [Pattern(null, "/")] (_, string) _Div = default
        ) : Node;
    public partial record Add(
        [Pattern(null, "+")] (_, string) _Add = default
        ) : Node;
    public partial record Sub(
        [Pattern(null, "-")] (_, string) _Sub = default
        ) : Node;
    ...
    public partial record Top(
        ...
        [Pattern(0, 2)] (_, Expression Exp, _) _Expression_ = default
        ) : Node;
}
