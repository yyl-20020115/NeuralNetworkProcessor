...
namespace QuickGraph
{
        ...
        where TEdge : IEdge<TVertex>
    {
        ...
        public TVertex Source
        {
            ...
            set { this.OriginalEdge.Target = value; }
        }

        public TVertex Target
        {
            get { return this.OriginalEdge.Source; }
            set { this.OriginalEdge.Source = value; }
        }
        ...
        IEdge<TVertex> IEdge<TVertex>.Clone() => new SReversedEdge<TVertex, TEdge>(this.originalEdge);
    }
}
