...
public class Label
{
    ...
    public static string ToLabelIndex(int num) => "." + num.ToString("x8");

    private int anonymouseCount = 0;
    private Stack<int> stack = new(MaxStack);
    private int usedCount = 0;
    private int localCount = 0;
    private Dictionary<string, ulong> definedList = new();
    private Dictionary<string, List<JmpLabel>> undefinedList = new();
    ...
    public bool HasUndefinedLabel() => undefinedList.Count != 0;
