...
public class Lexer
{
    ...
    public Token CurrentToken => new(_token, _value, location, endLocation);
    ...
    private static readonly Dictionary<string, int> _kwTokens = new()
    {
        { "auto", TokenKind.AUTO },
        { "bool", TokenKind.BOOL },
    ...
    public static readonly HashSet<int> KeywordTokens = new(_kwTokens.Values);
    ...
    static bool IsHex (char c) => c switch {
        'a' or 'b' or 'c' or 'd' or 'e' or 'f' or 'A' or 'B' or 'C' or 'D' or 'E' or 'F' => true,
        _ => false,
    };
}
