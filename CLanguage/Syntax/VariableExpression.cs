...
public class VariableExpression : Expression
{
    ...
    public override CType GetEvaluatedCType (EmitContext ec) => ec.ResolveVariable (this, null).VariableType;
    ...
    public override Value EvalConstant (EmitContext ec)
    {
        ...
        return res != null && res.Scope == VariableScope.Constant ? res.Constant : base.EvalConstant (ec);
    }
}
