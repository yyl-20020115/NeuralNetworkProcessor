...
public class AssignExpression (Expression left, Expression right) : Expression
{
    public Expression Left { get; private set; } = left;
    public Expression Right { get; private set; } = right;

    public override CType GetEvaluatedCType (EmitContext ec) => Left.GetEvaluatedCType (ec);
