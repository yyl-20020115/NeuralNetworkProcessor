...
namespace GraphSharp.Algorithms.Layout
{
		...
		where TParam : class, ILayoutParameters
	{
        ...
        {
            this.IterationEnded += ParameterizedLayoutAlgorithmBase_IterationEnded;
        }
        ...
        protected virtual void ParameterizedLayoutAlgorithmBase_IterationEnded(object sender, ILayoutInfoIterationEventArgs<TVertex, TEdge, TVertexInfo, TEdgeInfo> e)
        {
        }
		...
		where TParam : class, ILayoutParameters
	{
		...
		/// </summary>
		public virtual TParam Parameters { get; protected set; }
