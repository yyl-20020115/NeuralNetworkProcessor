...
namespace SharpLua
{
    ...
    public partial class Lua
    {
		...
		*/
        ...
        public static TValue gfasttm(global_State g, Table et, TMS e) => (et == null) ? null :
            ((et.flags & (1 << (int)e)) != 0) ? null :
            luaT_gettm(et, e, g.tmname[(int)e]);

        public static TValue fasttm(lua_State l, Table et, TMS e) => gfasttm(G(l), et, e);
		...
		*/
        ...
        {
            /*const*/
            var tm = luaH_getstr(events, ename);
