    ...
    public partial class Lua
    {
		...
		*/
        public class Value
        {
            ...
            // to set it.
            public void Copy(Value copy) => this.p = copy.p;

            public GCObject gc
            {
                get => (this.p is GCObject o) ? o : null;
                set => this.p = value;
            }
            public object p;
            public lua_Number n
            {
                get => (lua_Number)this.p;
                set => this.p = value;
            }
            public int b
            {
                get => (this.p is int i)? i:0;
                set => this.p = value;
            }
        }
		...
		*/
        ...
        public class lua_TValue : ArrayElement
        {
            ...
            public lua_TValue this[int offset] => this.values[this.index + offset];
            public lua_TValue this[uint offset] => this.values[this.index + (int)offset];
            public static lua_TValue operator +(lua_TValue value, int offset) => value.values[value.index + offset];
            public static lua_TValue operator +(int offset, lua_TValue value) => value.values[value.index + offset];
            public static lua_TValue operator -(lua_TValue value, int offset) => value.values[value.index - offset];
            ...
            public static implicit operator int(lua_TValue value) => value.index;
            public lua_TValue() { }
        ...
        /* Macros to test type */
        internal static bool ttisnil(TValue o) => (ttype(o) == LUA_TNIL);
        internal static bool ttisnumber(TValue o) => (ttype(o) == LUA_TNUMBER);
        internal static bool ttisstring(TValue o) => (ttype(o) == LUA_TSTRING);
        internal static bool ttistable(TValue o) => (ttype(o) == LUA_TTABLE);
        internal static bool ttisfunction(TValue o) => (ttype(o) == LUA_TFUNCTION);
        internal static bool ttisboolean(TValue o) => (ttype(o) == LUA_TBOOLEAN);
        internal static bool ttisuserdata(TValue o) => (ttype(o) == LUA_TUSERDATA);
        internal static bool ttisthread(TValue o) => (ttype(o) == LUA_TTHREAD);
        internal static bool ttislightuserdata(TValue o) => (ttype(o) == LUA_TLIGHTUSERDATA);

        /* Macros to access values */
#if DEBUG
        internal static int ttype(TValue o) => o.tt;
        internal static int ttype(CommonHeader o) => o.tt;
        internal static GCObject gcvalue(TValue o) => (GCObject)check_exp(iscollectable(o), o.value.gc);
        internal static object pvalue(TValue o) => (object)check_exp(ttislightuserdata(o), o.value.p);
        internal static lua_Number nvalue(TValue o) => (lua_Number)check_exp(ttisnumber(o), o.value.n);
        internal static TString rawtsvalue(TValue o) => (TString)check_exp(ttisstring(o), o.value.gc.ts);
        internal static TString_tsv tsvalue(TValue o) => rawtsvalue(o).tsv;
        internal static Udata rawuvalue(TValue o) => (Udata)check_exp(ttisuserdata(o), o.value.gc.u);
        internal static Udata_uv uvalue(TValue o) => rawuvalue(o).uv;
        internal static Closure clvalue(TValue o) => (Closure)check_exp(ttisfunction(o), o.value.gc.cl);
        internal static Table hvalue(TValue o) => (Table)check_exp(ttistable(o), o.value.gc.h);
        internal static int bvalue(TValue o) => (int)check_exp(ttisboolean(o), o.value.b);
        internal static lua_State thvalue(TValue o) => (lua_State)check_exp(ttisthread(o), o.value.gc.th);
#else
		internal static int ttype(TValue o) => o.tt;
		internal static int ttype(CommonHeader o) => o.tt;
		internal static GCObject gcvalue(TValue o) => o.value.gc;
		internal static object pvalue(TValue o) => o.value.p;
		internal static lua_Number nvalue(TValue o) => o.value.n;
		internal static TString rawtsvalue(TValue o) => o.value.gc.ts;
		internal static TString_tsv tsvalue(TValue o) => rawtsvalue(o).tsv;
		internal static Udata rawuvalue(TValue o) => o.value.gc.u;
		internal static Udata_uv uvalue(TValue o) => rawuvalue(o).uv;
		internal static Closure clvalue(TValue o) => o.value.gc.cl;
		internal static Table hvalue(TValue o) => o.value.gc.h;
		internal static int bvalue(TValue o) => o.value.b;
		internal static lua_State thvalue(TValue o) => (lua_State)check_exp(ttisthread(o), o.value.gc.th);
#endif
        public static int l_isfalse(TValue o) => ((ttisnil(o) || (ttisboolean(o) && bvalue(o) == 0))) ? 1 : 0;

        /*
		** for internal debug only
		*/
        [Conditional("DEBUG")]
        internal static void checkconsistency(TValue obj) => lua_assert(!iscollectable(obj) || (ttype(obj) == (obj).value.gc.gch.tt));

        [Conditional("DEBUG")]
        internal static void checkliveness(global_State g, TValue obj) => lua_assert(!iscollectable(obj) ||
            ((ttype(obj) == obj.value.gc.gch.tt) && !isdead(g, obj.value.gc)));

        /* Macros to set values */
        internal static void setnilvalue(TValue obj) => obj.tt = LUA_TNIL;
		...
		*/
        ...
        internal static bool iscollectable(TValue o) => (ttype(o) >= LUA_TSTRING);
		...
		*/
        ...
        public class TString : TString_tsv
        {
            ...
            public TString_tsv tsv => this;

            public TString() { }            
            public TString(CharPtr str) => this.str = str;

            public CharPtr str;
            public override string ToString() => str.ToString();  // for debugging
        }

        public static CharPtr getstr(TString ts) => ts.str;
        public static CharPtr svalue(StkId o) => getstr(rawtsvalue(o));
		...
		*/
        public class Proto : GCObject
        {
            ...
            public int index = 0;
            public Proto this[int offset] => this.protos[this.index + offset];
		...
		*/
        ...
        public class ClosureType
        {
            ...
            public static implicit operator ClosureHeader(ClosureType ctype) => ctype.header;
            public ClosureType(ClosureHeader header) => this.header = header;

            public lu_byte isC { get => header.isC; set => header.isC = value; }
            public lu_byte nupvalues { get => header.nupvalues; set => header.nupvalues = value; }
            public GCObject gclist { get => header.gclist; set => header.gclist = value; }
            public Table env { get => header.env; set => header.env = value; }
        }
        ...
        public static bool iscfunction(TValue o) => ((ttype(o) == LUA_TFUNCTION) && (clvalue(o).c.isC != 0));
        public static bool isLfunction(TValue o) => ((ttype(o) == LUA_TFUNCTION) && (clvalue(o).c.isC == 0));
		...
		*/
        ...
        {
            public TKey_nk() { }
            public TKey_nk(Value value, int tt, Node next) => this.next = next;
        ...
        public class Node : ArrayElement
        {
            ...
            public Node this[uint offset] => this.values[this.index + (int)offset];

            public Node this[int offset] => this.values[this.index + offset];
            ...
            public override bool Equals(object o) => this == (Node)o;
		...
		*/
        ...
        internal static int twoto(int x) => 1 << x;
        internal static int sizenode(Table t) => twoto(t.lsizenode);

        public static TValue luaO_nilobject_ = new TValue(new Value(), LUA_TNIL);
        public static TValue luaO_nilobject = luaO_nilobject_;
        public static int ceillog2(int x) => luaO_log2((uint)(x - 1)) + 1;
