...
namespace SharpLua
{
    ...
    {
        /* table of globals */
        public static TValue gt(lua_State L) => L.l_gt;
        /* registry */
        public static TValue registry(lua_State L) => G(L).l_registry;
		...
		*/
        public class CallInfo : ArrayElement
        {
            ...
            public CallInfo this[int offset] => values[index + offset];
            public static CallInfo operator +(CallInfo value, int offset) => value.values[value.index + offset];
            public static CallInfo operator -(CallInfo value, int offset) => value.values[value.index - offset];
        ...
        public static Closure curr_func(lua_State L) => (clvalue(L.ci.func));
        public static Closure ci_func(CallInfo ci) => (clvalue(ci.func));
        public static bool f_isLua(CallInfo ci) => ci_func(ci).c.isC == 0;
        public static bool isLua(CallInfo ci) => (ttisfunction((ci).func) && f_isLua(ci));
		...
		*/
        ...
        public static global_State G(lua_State L) => L.l_G;
		...
		*/
        public class GCObject : GCheader, ArrayElement
        {
            ...
            public GCheader gch => (GCheader)this;
            public TString ts => (TString)this;
            public Udata u => (Udata)this;
            public Closure cl => (Closure)this;
            public Table h => (Table)this;
            public Proto p => (Proto)this;
            public UpVal uv => (UpVal)this;
            public lua_State th => (lua_State)this;
        }
        ...
        public class ArrayRef : GCObjectRef, ArrayElement
        {
            ...
            public GCObject get() => array_elements[array_index];
            public void set_index(int index) => this.index = index;
        ...
        public class OpenValRef : GCObjectRef
        {
            ...
            public GCObject get() => this.L.openupval;
            lua_State L;
        }
        ...
        public class RootGCRef : GCObjectRef
        {
            ...
            public GCObject get() => this.g.rootgc;
        ...
        public class NextRef : GCObjectRef
        {
            ...
            public GCObject get() => this.header.next;
            public GCheader header;
        }

        /* macros to convert a GCObject into a specific value */
        public static TString rawgco2ts(GCObject o) => (TString)check_exp(o.gch.tt == LUA_TSTRING, o.ts);
        public static TString gco2ts(GCObject o) => (TString)(rawgco2ts(o).tsv);
        public static Udata rawgco2u(GCObject o) => (Udata)check_exp(o.gch.tt == LUA_TUSERDATA, o.u);
        public static Udata gco2u(GCObject o) => (Udata)(rawgco2u(o).uv);
        public static Closure gco2cl(GCObject o) => (Closure)check_exp(o.gch.tt == LUA_TFUNCTION, o.cl);
        public static Table gco2h(GCObject o) => (Table)check_exp(o.gch.tt == LUA_TTABLE, o.h);
        public static Proto gco2p(GCObject o) => (Proto)check_exp(o.gch.tt == LUA_TPROTO, o.p);
        public static UpVal gco2uv(GCObject o) => (UpVal)check_exp(o.gch.tt == LUA_TUPVAL, o.uv);
        public static UpVal ngcotouv(GCObject o) => (UpVal)check_exp((o == null) || (o.gch.tt == LUA_TUPVAL), o.uv);
        public static lua_State gco2th(GCObject o) => (lua_State)check_exp(o.gch.tt == LUA_TTHREAD, o.th);
        /* macro to convert any Lua object into a GCObject */
        public static GCObject obj2gco(object v) => (GCObject)v;
        public static int state_size(object x) => Marshal.SizeOf(x) + LUAI_EXTRASPACE;
        /*
		...
		*/
        ...
        public static lua_State lua_newstate(lua_Alloc f, object ud)
        {
            ...
            g.gcdept = 0;
            for (int i = 0; i < NUM_TAGS; i++) g.mt[i] = null;
