...
namespace SharpAssembler.Architectures.X86
{
	partial class X86Instruction
	{
		...
		internal enum OperandEncoding
		{
			...
			/// <item>
			/// <term><see cref="SharpAssembler.Architectures.X86.X86Instruction.OperandType.RegisterOperand"/></term>
			...
			/// <see cref="SharpAssembler.Architectures.X86.X86Instruction.OperandType.RegisterOperand"/> operand type.
			/// </summary>
			/// <remarks>This has the following influence on the operand's encoding:
			/// <list type="table">
			/// <listheader><term>Operand type</term><description>Encoding</description></listheader>
			...
			/// <see cref="SharpAssembler.Architectures.X86.X86Instruction.OperandType.Immediate"/> operand type.
			/// </summary>
			ExtraImmediate,
		}
	}
