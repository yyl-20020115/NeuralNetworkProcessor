...
namespace SharpAssembler.Architectures.X86.Instructions
{
	...
	/// </summary>
	public class Outs : X86Instruction
	{
		#region Constructors
		/// <summary>
		/// Initializes a new instance of the <see cref="Outs"/> class.
		/// </summary>
		/// <param name="size">The size of the data to compare.</param>
		public Outs(DataSize size)
		{
			#region Contract
		...
		private static InstructionVariant[] variants = new[]{
			...
			new InstructionVariant(
				new byte[] { 0x6E }, DataSize.Bit8),
			// OUTSW
			new InstructionVariant(
				new byte[] { 0x6F }, DataSize.Bit16),
			// OUTSD
			new InstructionVariant(
				new byte[] { 0x6F }, DataSize.Bit32),
		};
