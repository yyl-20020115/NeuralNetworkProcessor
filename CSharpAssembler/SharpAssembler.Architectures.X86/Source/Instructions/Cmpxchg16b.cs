...
namespace SharpAssembler.Architectures.X86.Instructions
{
	...
	/// </summary>
	public class Cmpxchg16b : X86Instruction, ILockInstruction
	{
		#region Constructors
		/// <summary>
		/// Initializes a new instance of the <see cref="Cmpxchg16b"/> class.
		/// </summary>
		/// <param name="destination">The operand being compared and written to.</param>
		public Cmpxchg16b(EffectiveAddress destination)
		{
			#region Contract
		...
		private static InstructionVariant[] variants = new[]{
			...
			new InstructionVariant(
				...
				new OperandDescriptor(OperandType.MemoryOperand, DataSize.Bit128)),
		};
