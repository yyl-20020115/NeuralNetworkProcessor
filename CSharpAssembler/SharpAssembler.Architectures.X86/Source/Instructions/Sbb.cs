...
namespace SharpAssembler.Architectures.X86.Instructions
{
	...
	/// </summary>
	public class Sbb : X86Instruction, ILockInstruction
	{
		#region Constructors
		/// <summary>
		...
		public Sbb(RegisterOperand destination, RegisterOperand source)
			: this((Operand)destination, (Operand)source)
		{
			#region Contract
			Contract.Requires<ArgumentNullException>(destination != null);
		...
		public Sbb(RegisterOperand destination, EffectiveAddress source)
			: this((Operand)destination, (Operand)source)
		{
			#region Contract
			Contract.Requires<ArgumentNullException>(destination != null);
		...
		private Sbb(Operand destination, Operand source)
		{
			#region Contract
			Contract.Requires<ArgumentNullException>(destination != null);
