...
public class SymbolEntry<T> : ISymbolEntry where T : struct
{
    ...
    public SpecialSectionIndex SpecialPointedSectionIndex => IsPointedIndexSpecial
                ? (SpecialSectionIndex)PointedSectionIndex
    ...
    public override string ToString() => string.Format("[{3} {4} {0}: 0x{1:X}, size: {2}, section idx: {5}]",
